# Дипломный проект курса  «Python: программирование на каждый день и сверхбыстрое прототипирование» 

Запуск скрипта spy_games.py, параметр коммандной строки(не обязательный) - Имя пользователя или его id в ВК
